...
// window.onload = function() {
    // if ('http://localhost:3000/html/invalid.html') {
        new SibApiV3Sdk.TransactionalEmailsApi().sendTransacEmail({
                    ...
                    "htmlContent":"<!DOCTYPE html><html><body><h1>Dear Customer,</h1><p>There has been an attempt to enter you bank account. Please contact us if it was not you.<br> you may ignore this mail if it is not case.</p></body></html>",
                    "params":{
