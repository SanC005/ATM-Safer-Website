...
// window.onload = function() {
    // if ('http://localhost:3000/html/invalid.html') {
        new SibApiV3Sdk.TransactionalEmailsApi().sendTransacEmail({
                    ...
                    "htmlContent":"<!DOCTYPE html><html><body><h1>Dear Customer,</h1><p>There has been an attempt to enter you bank account. Please contact us if it was not you.<br>  else you mat ignore this mail.</p></body></html>",
                    "params":{
